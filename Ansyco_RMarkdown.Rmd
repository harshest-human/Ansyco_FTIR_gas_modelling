...
```{r message=FALSE, warning=FALSE}
FTIR_input <- read.table(paste0("D:/HARSHY DATA 2020/Master Thesis/Ansyco FTIR Data/Ansyco_FTIR_modelling/20210902_Vertical_Pipes_Harsh_06nov.TXT"), 
                         header = T, fill = TRUE) %>%
...
#### Combining dataframes (FTIR + Wind + DWD Data) and sorting wind direction
